...
{$R *.fmx}
  Var ClRecDft : TColor; //cela nous permettera de changer la couleur du rectangle en conception sans la changer en code(plus de fléxibilitè).
      ClTxtDft : Tcolor;
...
begin
  ...
  Rectangle1.Fill.Color := ($FF31976F); //Assigner une nouvelle couleur à l'entrée de la souris.
...
begin
  ...
  //Rectangle1.Fill.Color := ($FFE0E0E0); //ce code là restreint un peu les possibilités et limite l'utilisateur, c'est pour ça qu'il vaut mieux definir une couleur par defaut(CouleurDef) vers la quelle retourner.
end;
