...
respondance base de donnée de la chaine qui lui est donnée, mais 2 c'est pour
revoyer le nom de la table '.' la correspondance base de données "Employe.idEmp" }
